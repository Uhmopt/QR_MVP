                ...
                <div class="card">
                    <div class="card-header bg-white text-center">
                        ...
                        <h4 class="heading mt-4">
                            ...
                            {{ __('/'.$branch->name) }}
                            @endif &nbsp;
                            @if(count($restorant->ratings == null ? array() : $restorant->ratings ))
                                <span><i class="fa fa-star" style="color: #dc3545"></i>
                                <strong>
                                {{ number_format($restorant->averageRating, 1, '.', ',') }}
                                <span class="small">/ 5 ({{ count($restorant->ratings == null ? array() : $restorant->ratings ) }})</strong></span></span>
                            @endif
                        </h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                @if(count($restorant->ratings == null ? array() : $restorant->ratings ) != 0)
                                    <br/>
                                    <h5>{{ count($restorant->ratings == null ? array() : $restorant->ratings ) }} {{ count($restorant->ratings == null ? array() : $restorant->ratings ) == 1 ? __('Review') : __('Reviews')}}</h5>
                                    <hr />
