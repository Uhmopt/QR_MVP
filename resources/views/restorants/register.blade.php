                    ...
                    <div class="card-body">
                        <form  id="registerform" method="post" action="{{ route('newrestaurant.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('wish_branch_number') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="wish_branch_number">{{ __('Wish Number of Branch') }}</label>
                                    <input type="number" step="1" name="wish_branch_number" id="wish_branch_number" class="form-control form-control-alternative{{ $errors->has('wish_branch_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Minimum one branch restaurant') }} ..." value="{{ isset($_GET["phone"])?$_GET['phone']:""}}" required autofocus>

                                    @if ($errors->has('wish_branch_number'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('wish_branch_number') }}</strong>
                                        </span>
                                    @endif
                                </div>
