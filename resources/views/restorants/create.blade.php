                ...
                <div class="card-body">
                    ...
                    <div class="pl-lg-4">
                        <form method="post" action="{{ route('admin.restaurants.store') }}" autocomplete="off">
                            ...
                            <div class="form-group{{ $errors->has('branchnum') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="branchnum">{{ __('Branch number') }}</label>
                                <input type="number" name="branchnum" id="branchnum"
                                    class="form-control form-control-alternative{{ $errors->has('branchnum') ? ' is-invalid' : '' }}"
                                    placeholder="{{ __('Branch number here') }} ..." value="" required autofocus>
                                @if ($errors->has('branchnum'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('branchnum') }}</strong>
                                </span>
                                @endif
                            </div>
                            <hr />
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name_owner') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name_owner" id="name_owner"
                                        ...
                                        placeholder="{{ __('Owner Name here') }} ..." value="" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('email_owner') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="email" name="email_owner" id="email_owner"
                                        ...
                                        placeholder="{{ __('Owner Email here') }} ..." value="" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('phone_owner') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="phone_owner" id="phone_owner"
                                        ...
                                        placeholder="{{ __('Owner Phone here') }} ..." value="" required autofocus>
