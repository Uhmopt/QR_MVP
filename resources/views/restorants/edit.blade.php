                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            ...
                            <span
                                class="blockquote-footer">{{ (isset($_SERVER['HTTPS'])&&$_SERVER["HTTPS"] ?"https://":"http://").$restorant->subdomain.".".$_SERVER['HTTP_HOST'] }}</span>
                            @endif
                        </div>
                    ...
                    <div class="pl-lg-4">
                        <form method="post" action="{{ route('admin.restaurants.update', $restorant) }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            @if(auth()->user()->hasRole('admin'))
                                ...
                                ['ftype'=>'input','type' => 'number', 'name'=>"Wish Branch Number",'id'=>"wishbranchnum",'placeholder'=>"Branch Number",'required'=>true, 'step'=>'1','value'=>$restorant->wishbranchnum, 'readonly'=>'true'],
                                ['ftype'=>'input','type' => 'number', 'name'=>"Branch Number",'id'=>"branchnum",'placeholder'=>"Branch
                                Number",'required'=>true, 'step'=>'1','value'=>$restorant->branchnum],
                                ['ftype'=>'input','name'=>"Restaurant
                                Description",'id'=>"description",'placeholder'=>"Restaurant
                                description",'required'=>true,'value'=>$restorant->description],
                                ['ftype'=>'input','name'=>"Restaurant Address",'id'=>"address",'placeholder'=>"Restaurant
                                description",'required'=>true,'value'=>$restorant->address],
                                ]])
                            @endif
                            ...
                            @if(auth()->user()->hasRole('owner'))
                                @include('partials.fields',['fields'=>[
                                ['ftype'=>'input','name'=>"Restaurant Name",'id'=>"name",'placeholder'=>"Restaurant Name",'required'=>true,'value'=>$restorant->name],
                                ['ftype'=>'input','type' => 'number', 'name'=>"Wish Branch Number",'id'=>"wishbranchnum",'placeholder'=>"Branch Number",'required'=>true, 'step'=>'1','value'=>$restorant->wishbranchnum],
                                ['ftype'=>'input','type' => 'number', 'name'=>"Branch Number",'id'=>"branchnum",'placeholder'=>"Branch
                                Number",'required'=>true,'readonly'=>'true', 'step'=>'1', 'value'=>$restorant->branchnum],
                                ['ftype'=>'input','name'=>"Restaurant
                                Description",'id'=>"description",'placeholder'=>"Restaurant
                                description",'required'=>true,'value'=>$restorant->description],
                                ['ftype'=>'input','name'=>"Restaurant Address",'id'=>"address",'placeholder'=>"Restaurant
                            ...
                            @include('partials.fields',['fields'=>[
                            ['ftype'=>'select','name'=>"Restaurant
                            city",'id'=>"city_id",'data'=>$cities,'required'=>true,'value'=>$restorant->city_id],
                            ...
                            <div class="row">
                                <div class="col-6 form-group{{ $errors->has('fee') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="fee" id="input-fee" step="any" min="0" max="100"
                                ...
                                <div class="col-6 form-group{{ $errors->has('static_fee') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="static_fee" id="input-fee" step="any" min="0" max="100"
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-toggle" style="float: right">
                                    <input type="checkbox" name="is_featured"
                                        <?php if($restorant->is_featured == 1){echo "checked";}?>>
                            ...
                            <div class="row">
                                <?php
                                    $images=[
                                        ['name'=>'resto_logo','label'=>__('Restaurant Logo'),'value'=>$restorant->logom,'style'=>'width: 295px; height: 200px;'],
            ...
            if (currPost.lat != 0 && currPost.lng != 0) {
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        map_location.addListener('click', function(event) {
                            marker.setPosition(new google.maps.LatLng(event.latLng.lat(),
                                event.latLng.lng()));
